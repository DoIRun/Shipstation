<?php
namespace DoIRun\Shipstation\Model\Action;
        ...
        if (!empty($order->getItems())) {
            ...
            foreach ($order->getItems() as $orderItem) {
                ...
                if ($this->_priceType) {
                    ...
                    $price = $orderItem->getBasePrice() - ($orderItem->getBaseDiscountAmount() / $orderItem->getQtyOrdered());
                } else {
                    ...
                    if ($type == self::TYPE_CONFIGURABLE) {
                        if ($price == '0.0000' || $price == null) {
                            if ($this->_priceType) {
                                ...
                                $price = $parentItem->getBasePrice() - ($parentItem->getBaseDiscountAmount() / $orderItem->getQtyOrdered());
                            } else {
